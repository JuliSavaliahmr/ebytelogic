            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 space-y-4">
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 pt-4'>
                    {currentCards.map((card, index) => (
                        <div key={index} className="bg-white border border-gray-200 shadow-[rgba(0,0,0,0.1)_0px_5px_25px] flex flex-col">
                            <a href="#">
                            ...
                            <div className="space-y-4 text-primaryText p-7">
                                ...
                                <h3 onClick={() => router.push("/blogs/blog-details")} className="text-lg sm:text-[21px] leading-normal cursor-pointer hover:text-primary transition-colors duration-300">
                                    {card.title}
                                </h3>
                            </div>
                        </div>

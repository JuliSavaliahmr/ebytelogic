...
const AboutHero = () => {
    return (
        <div className='relative bg-[url("/images/aboutBanner.jpg")] bg-no-repeat bg-cover py-28 lg:py-52'>
            <div className='absolute bg-[#0e191eb3] top-0 size-full z-0'></div>
            <div className='max-w-[1170px] mx-auto px-4 sm:px-6 relative z-10'>

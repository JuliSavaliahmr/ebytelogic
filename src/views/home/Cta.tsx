...
const Cta = () => {
    ...
    return (
        <section className="relative bg-[url('/images/cta.jpg')] bg-cover bg-fixed bg-center py-20 px-6">
            ...
            <div className="relative z-10 space-y-4 max-w-4xl mx-auto text-center text-white">
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a
                        href="/case-studies"
                        className="inline-flex items-center text-white hover:text-primary-300 font-medium transition-all duration-300"
                    >

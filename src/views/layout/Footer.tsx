                    ...
                    <footer className="text-gray-700">
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 gap-3 md:gap-10">
                            <div className='xl:col-span-4 md:col-span-2 col-span-12'>
                                ...
                                <div className="flex flex-wrap 2xl:flex-nowrap gap-2 sm:gap-0">
                                    <input
                                        type="email"
                                        placeholder="Enter your work email"
                                        className="max-w-[273px] px-4 py-2 bg-white sm:shadow-lg focus:outline-none text-sm"
                                    />
                                    <Button variant='default' className="max-w-[153px] w-full bg-primary text-white px-6 py-2 text-sm sm:text-[15px]">
                                        Stay Updated
                                    </Button>
                                </div>
                            </div>
                            <div className="xl:col-span-5 md:col-span-1 flex flex-wrap justify-center sm:gap-4 col-span-12">
                                <div>
                                    <h3 className="font-medium text-primaryText text-xl mb-3">Explore</h3>
                                    <ul className="space-y-2 text-sm text-gray-600">
                                        <li className='flex items-center gap-1 text-primaryText text-sm sm:text-[15px] cursor-pointer transition-all duration-300 hover:text-primary'><MdKeyboardArrowRight />About Us</li>
                                        <li className='flex items-center gap-1 text-primaryText text-sm sm:text-[15px] cursor-pointer transition-all duration-300 hover:text-primary'><MdKeyboardArrowRight />Case Studies</li>
                                        <li className='flex items-center gap-1 text-primaryText text-sm sm:text-[15px] cursor-pointer transition-all duration-300 hover:text-primary'><MdKeyboardArrowRight />Services</li>
                                        <li className='flex items-center gap-1 text-primaryText text-sm sm:text-[15px] cursor-pointer transition-all duration-300 hover:text-primary'><MdKeyboardArrowRight />Industries We Serve</li>
                                        <li className='flex items-center gap-1 text-primaryText text-sm sm:text-[15px] cursor-pointer transition-all duration-300 hover:text-primary'><MdKeyboardArrowRight />Careers</li>
                                        <li className='flex items-center gap-1 text-primaryText text-sm sm:text-[15px] cursor-pointer transition-all duration-300 hover:text-primary'><MdKeyboardArrowRight />Contact Us</li>
                                    </ul>
                                </div>
                                <div>
